...
export const NewAccountForm = () => {
  ...
  const handleSubmit = async(event) => {
    ...
    const formData = new FormData(event.target); //obtngo el FormData del formulario
    await handleCreateUser(formData); //ejecuto la accion creada en la carpeta ACTIONS
  }
